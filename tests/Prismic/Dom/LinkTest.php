...
class LinkTest extends TestCase
{
    ...
    public function testWebLinkAsUrl(): void
    {
    ...
    public function testMediaLinkAsUrl(): void
    {
    ...
    public function testDocumentLinkAsUrl(): void
    {
    ...
    public function testDocumentLinkAsUrlWithoutLinkResolver(): void
    {
